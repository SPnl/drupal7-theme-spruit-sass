 ...
 */
	...
	$link = urlencode(url("node/1746", $options));
	$node_title = htmlspecialchars('Stop de huurverhoging');
	$cta_title = 'Stop de huurverhoging';
	$cta_subtitle = '';
	$facebook = 'https://www.facebook.com/sharer/sharer.php?u='.$link;
	$og_description = urlencode('Vorig jaar had al de helft van de huurders moeite om de huur te kunnen betalen. Nu lopen van velen de inkomsten terug en komt er toch nog weer een huurverhoging aan. Dat moeten we stoppen.');
	...
	$email_body = rawurlencode('<p>Vorig jaar had al de helft van de huurders moeite om de huur te kunnen betalen. Nu lopen van velen de inkomsten terug en komt er toch nog weer een huurverhoging aan. Dat moeten we stoppen.</p>Sluit je ook aan via: ').url("node/1746", $options).'?ref=share-mail';
