(function ($) {
  Drupal.behaviors.Stemover = {
    attach: function (context, settings) {

      /* old counter
      <div id="countdown">
        <div><span class="days"></span><div class="smalltext">Dagen</div></div>
        <div><span class="hours"></span><div class="smalltext">Uur</div></div>
        <div><span class="minutes"></span><div class="smalltext">Minuten</div></div>
        <div><span class="seconds"></span><div class="smalltext">Seconden</div></div>
      </div>
      */
      ...
      if (countdown_status = "first" || "second" || "final"){
        setInterval(function () {
          ...
          if (countdown_status == "first") {
            ...
            countdown.innerHTML = "<h1>Gemeenteraadsverkiezingen</h1><h2>Stem over " + hours + ":" + minutes + ":" + seconds + " uur</h2><p>Je kunt SP stemmen in de volgende gemeentes. Klik voor meer informatie over kandidaten, standpunten op één van de gemeentes.</p>";
          ...
          if (countdown_status == "second") {
            ...
            countdown.innerHTML = "<h2>Stem over " + hours + ":" + minutes + ":" + seconds + "</h2><p>Je kunt SP stemmen in de volgende gemeentes. Klik voor meer informatie over kandidaten, standpunten op één van de gemeentes.</p>";
            //days_span.innerHTML = days;
            //hours_span.innerHTML = hours;
            //minutes_span.innerHTML = minutes;
            //seconds_span.innerHTML = seconds;
          ...
          if (countdown_status == "final") {
            countdown.innerHTML = "<h2>SP stemmers bedankt!</h2>";
